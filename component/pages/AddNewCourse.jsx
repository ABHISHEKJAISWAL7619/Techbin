    ...
    <div className="w-full px-4 py-6">
      <div className="max-w-4xl mx-auto">
       ...
       <div className="bg-gray-300 rounded-lg h-32 w-40 flex justify-center items-center mb-5">
        ...
        <div className="" >
          <input ref={addcategoryref} type="text" className="border rounded-2xl border-gray-500 pl-2" placeholder="enter category... " /> 
          <button  onClick={handleaddcatory} className="bg-blue-700 h-6 w-16 ml-5 border border-black text-white rounded-xl" >ADD</button>
        </div>
       </div>
